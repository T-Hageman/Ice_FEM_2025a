...
\newcommand{\citeMe}{\href{https://doi.org/10.1016/j.cma.2026.118857}{T Hageman. \textit{Phase-field fracture modelling of ice: From triaxial tests to ice-cliff collapse}. Computer Methods in Applied Mechanics and Engineering \citep{Hageman2026}}}

\begin{document}
\pagenumbering{gobble}
\begin{frontmatter}
\title{\includegraphics[width=4cm,trim={0 180 0 0}]{../Physics/Visualisation/Icon.png} IceFEM: A finite element code to simulate fracture and viscous/plastic deformation in ice.}
