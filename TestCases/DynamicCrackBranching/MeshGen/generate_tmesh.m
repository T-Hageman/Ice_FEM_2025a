...
for i=1:8
	switch i
		...
		case 3
			type = "Triangle";
			savename = "triangleLinear_02mm";
			dx = 0.2e-3;
			order = 1;
		case 4
			type = "Triangle";
			savename = "triangleQuadratic_02mm";
			dx = 0.2e-3;
			order = 2;
		case 5
			type = "B";
			savename = "quadratic_01mm";
			dx = 0.1e-3;
			order = 2;
		case 6
			type = "B";
		...
		case 7
			type = "Triangle";
			savename = "triangleLinear_01mm";
			dx = 0.1e-3;
			order = 1;
		case 8
			type = "Triangle";
			savename = "triangleQuadratic_01mm";
			dx = 0.1e-3;
			order = 2;
	end
